...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void initState() {
    ...
    // Prepare focus nodes for the sidebar menu
    for (int i = 0; i < 5; i++) {
    ...
    // Auto-focus the first sidebar item when settings screen opens
  ...
  void _focusFirstContentElement() {
    // Focus the first interactive element in the current content area
    Future.microtask(() {
      if (_selectedIndex == 0) {
        // General - focus M3U tab button
        _m3uTabFocusNode.requestFocus();
      } else if (_selectedIndex == 1) {
        // Account
        _editProfileButtonFocusNode.requestFocus();
      } else if (_selectedIndex == 2) {
        // Playback - focus first switch
        _playbackFirstFocusNode.requestFocus();
      } else if (_selectedIndex == 3) {
        // AI Features - focus first switch
  ...
  Widget _buildRightPane() {
    return FocusScope(
      ...
      child: Builder(
        builder: (context) {
          // Build only the active content to reduce memory use
  ...
  void requestFirstContentFocus() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      // Focus the first input field based on current selection
      switch (_selectedIndex) {
        case 0: // General
        ...
        case 4: // Recordings
        default:
          // For sections without specific focus nodes, just request focus on content scope
            ...
            _buildSectionCard(
              ...
              children: [
                ...
                _buildSwitchTile(
                  'Hero Video Preview',
                  _heroVideoPreview,
                  subtitle: 'Play live video in hero banner (experimental)',
                ),
              ],
            ),
          ],
