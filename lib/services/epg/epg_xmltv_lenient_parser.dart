...
// Fast-path pre-compiled regex to avoid chaining multiple string replacements
final RegExp _xmlEntityRegex = RegExp(r'&(amp|lt|gt|quot|apos);');

String decodeXmltvEntities(String input) {
  // Fast path: skip replacement logic if string contains no entities
  if (!input.contains('&')) return input;

  // Use a single replaceAllMapped call instead of chaining .replaceAll()
  // to avoid creating multiple intermediate string allocations.
