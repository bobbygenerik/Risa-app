...
// Replaced chained .replaceAll() with a fast-path check and single RegExp pass
// to reduce intermediate string allocations during XML parsing.
String decodeXmltvEntities(String input) {
  if (!input.contains('&')) return input;
  return input.replaceAllMapped(_xmlEntityRe, (match) {
