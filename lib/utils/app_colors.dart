...
class AppColors {
  ...
  static const Color focusBorder = Color(0xFF3B82F6); // Brighter blue for focus states
  ...
  static Color primaryWithOpacity(double opacity) => withOpacity(primary, opacity);
  static Color backgroundWithOpacity(double opacity) => withOpacity(background, opacity);
  static Color textPrimaryWithOpacity(double opacity) => withOpacity(textPrimary, opacity);
  static Color textSecondaryWithOpacity(double opacity) => withOpacity(textSecondary, opacity);
  static Color whiteWithOpacity(double opacity) => withOpacity(Colors.white, opacity);
  static Color blackWithOpacity(double opacity) => withOpacity(Colors.black, opacity);
}
