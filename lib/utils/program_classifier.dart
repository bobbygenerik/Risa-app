...
class ProgramClassifier {
  ...
  static bool isNewsProgram(Program? program, Channel channel) {
    ...
    if (title != null && title.isNotEmpty && _newsKeywords.hasMatch(title)) return true;
    ...
    if (title == null || title.isEmpty || EPGMatchingUtils.isGenericTitle(title)) {
      ...
      if (channelName.isNotEmpty && _newsKeywords.hasMatch(channelName)) return true;
  ...
  static bool isKidsProgram(Program? program, Channel channel) {
    ...
    if (title != null && title.isNotEmpty && _kidsExcludedShows.hasMatch(title)) {
      return false;
    }
    if (channelName.isNotEmpty && _kidsExcludedShows.hasMatch(channelName)) {
      return false;
    }
  ...
  static bool _matchesProgramOrChannel(
    ...
    final title = program?.title;
    if (title != null && title.isNotEmpty && pattern.hasMatch(title)) return true;
    ...
    final channelName = channel.name;
    if (channelName.isNotEmpty && pattern.hasMatch(channelName)) return true;
