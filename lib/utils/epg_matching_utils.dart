part 'epg_match_candidate.dart';
part 'epg_title_matching_utils.dart';
...
class EPGMatchingUtils {
  ...
  static String normalizeForFilter(String text) => normalizeChannelName(text);

  static String normalizeForArtwork(String title) =>
      EpgTitleMatchingUtils.normalizeForArtwork(title);

  static bool isLikelyNewsTitle(String title) =>
      EpgTitleMatchingUtils.isLikelyNewsTitle(title);

  static String normalizeForDisplayTitle(
    String title, {
    bool stripEpisodeSubtitle = false,
  }) =>
      EpgTitleMatchingUtils.normalizeForDisplayTitle(
        title,
        stripEpisodeSubtitle: stripEpisodeSubtitle,
      );

  static String stripEpisodeSubtitleLoose(String title) =>
      EpgTitleMatchingUtils.stripEpisodeSubtitleLoose(title);

  static Set<String> tokenizeForFuzzyMatch(String title) =>
      EpgTitleMatchingUtils.tokenizeForFuzzyMatch(title);
  ...
  static double scoreFuzzyMatch(
    ...
    Set<String> tokensB,
      ...
      EpgTitleMatchingUtils.scoreFuzzyMatch(
        titleA,
        titleB,
        tokensA,
        tokensB,
  ...
  static bool isGenericTitle(String title) =>
      EpgTitleMatchingUtils.isGenericTitle(title);

  static String normalizeArtworkVariant(String title) =>
      EpgTitleMatchingUtils.normalizeArtworkVariant(title);

  static String normalizeTitleForLookup(
    String title, {
    bool aggressiveForNews = false,
  }) =>
      EpgTitleMatchingUtils.normalizeTitleForLookup(
        title,
        aggressiveForNews: aggressiveForNews,
      );
}
