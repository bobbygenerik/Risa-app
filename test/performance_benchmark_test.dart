...
void main() {
  test('M3U Parsing Benchmark (10k channels)', () {
    ...
    for (int i = 0; i < count; i++) {
      sb.writeln('#EXTINF:-1 tvg-id="channel$i" tvg-logo="http://logo.com/$i.png" group-title="Benchmark", Channel $i');
    ...
    print('Avg per item: ${(stopwatch.elapsedMicroseconds / count).toStringAsFixed(2)}µs');
    print('==========================\n');
