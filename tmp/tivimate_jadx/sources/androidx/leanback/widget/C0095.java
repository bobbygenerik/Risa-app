...
public class C0095 {
    ...
    public final String toString() {
        ...
        if (!TextUtils.isEmpty(this.f871)) {
            sb.append(this.f871);
        }
        if (!TextUtils.isEmpty(this.f873)) {
            if (!TextUtils.isEmpty(this.f871)) {
                sb.append(" ");
            }
            sb.append(this.f873);
    ...
    /* renamed from: ˑﹳ, reason: contains not printable characters */
    public final void m581(String str, Bundle bundle) {
        int i;
        if (m579()) {
    ...
    /* renamed from: ﾞᴵ, reason: contains not printable characters */
    public final void m586(String str, Bundle bundle) {
        int i;
