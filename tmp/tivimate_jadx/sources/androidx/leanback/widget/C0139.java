...
public final class C0139 {
    ...
    public C0139(PagingIndicator pagingIndicator) {
    ...
    public final void m648() {
        this.f985 = 0.0f;
        this.f987 = 0.0f;
        PagingIndicator pagingIndicator = this.f986;
    ...
    public final void m649() {
        int round = Math.round(this.f992 * 255.0f);
        PagingIndicator pagingIndicator = this.f986;
        this.f991 = Color.argb(round, Color.red(pagingIndicator.f692), Color.green(pagingIndicator.f692), Color.blue(pagingIndicator.f692));
    }
}
