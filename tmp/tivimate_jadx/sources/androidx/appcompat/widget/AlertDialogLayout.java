...
public class AlertDialogLayout extends AbstractC2247 {
    public AlertDialogLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, 0);
    }

    /* renamed from: ˆʾ, reason: contains not printable characters */
    public static int m58(View view) {
        ...
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m58(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == R.id.4ji) {
                    ...
                    if ((id != R.id.2hs && id != R.id.nj) || view3 != null) {
        ...
        if (mode2 != 1073741824) {
            ...
            while (i13 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) c2295).width == -1) {
                        int i14 = ((LinearLayout.LayoutParams) c2295).height;
                        ((LinearLayout.LayoutParams) c2295).height = childAt3.getMeasuredHeight();
                        alertDialogLayout.measureChildWithMargins(childAt3, makeMeasureSpec, 0, i12, 0);
                        ((LinearLayout.LayoutParams) c2295).height = i14;
                    }
                }
                i13++;
