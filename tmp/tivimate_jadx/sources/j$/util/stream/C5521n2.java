...
public final class C5521n2 extends AbstractC5461b2 {
    public final /* synthetic */ long s;
    public final /* synthetic */ long t;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C5521n2(AbstractC5471d2 abstractC5471d2, int i, long j, long j2) {
    ...
    public final G0 M0(AbstractC5559v1 abstractC5559v1, Spliterator spliterator, IntFunction intFunction) {
        ...
        if (l0 > 0 && spliterator.hasCharacteristics(16384)) {
            ...
            return AbstractC5559v1.b0(abstractC5559v1, AbstractC5559v1.Y(abstractC5453a.L0(), spliterator, this.s, this.t), true, intFunction);
        }
        ...
        Spliterator G0 = abstractC5559v1.G0(spliterator);
        long j3 = this.s;
        long j4 = this.t;
        if (j3 <= l0) {
            long j5 = l0 - j3;
        ...
        return AbstractC5559v1.b0(this, new A3(G0, j2, j), true, intFunction);
    }
    ...
    public final Spliterator N0(AbstractC5453a abstractC5453a, Spliterator spliterator) {
        ...
        if (l0 > 0 && spliterator.hasCharacteristics(16384)) {
            Spliterator G0 = abstractC5453a.G0(spliterator);
            long j = this.s;
            return new C5546s3(G0, j, AbstractC5559v1.a0(j, this.t));
        }
        if (Y2.ORDERED.q(abstractC5453a.m)) {
            return ((G0) new C5560v2(this, abstractC5453a, spliterator, new C5459b0(4), this.s, this.t).invoke()).spliterator();
        }
        Spliterator G02 = abstractC5453a.G0(spliterator);
        long j2 = this.s;
        long j3 = this.t;
        if (j2 <= l0) {
            long j4 = l0 - j2;
