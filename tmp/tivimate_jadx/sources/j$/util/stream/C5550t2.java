...
public final class C5550t2 extends AbstractC5567x {
    public final /* synthetic */ long s;
    public final /* synthetic */ long t;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C5550t2(AbstractC5577z abstractC5577z, int i, long j, long j2) {
        super(abstractC5577z, i);
        this.s = j;
        this.t = j2;
    }
    ...
    public final G0 M0(AbstractC5559v1 abstractC5559v1, Spliterator spliterator, IntFunction intFunction) {
        ...
        if (l0 > 0 && spliterator.hasCharacteristics(16384)) {
            ...
            return AbstractC5559v1.c0(abstractC5559v1, AbstractC5559v1.Y(abstractC5453a.L0(), spliterator, this.s, this.t), true);
        }
        ...
        j$.util.U u = (j$.util.U) abstractC5559v1.G0(spliterator);
        long j3 = this.s;
        long j4 = this.t;
        if (j3 <= l0) {
            long j5 = l0 - j3;
        ...
        return AbstractC5559v1.c0(this, new A3(u, j2, j), true);
    }
    ...
    public final Spliterator N0(AbstractC5453a abstractC5453a, Spliterator spliterator) {
        ...
        if (l0 > 0 && spliterator.hasCharacteristics(16384)) {
            j$.util.U u = (j$.util.U) abstractC5453a.G0(spliterator);
            long j = this.s;
            return new AbstractC5541r3(u, j, AbstractC5559v1.a0(j, this.t));
        }
        if (Y2.ORDERED.q(abstractC5453a.m)) {
            return ((G0) new C5560v2(this, abstractC5453a, spliterator, new C5459b0(15), this.s, this.t).invoke()).spliterator();
        }
        j$.util.U u2 = (j$.util.U) abstractC5453a.G0(spliterator);
        long j2 = this.s;
        long j3 = this.t;
        if (j2 <= l0) {
            long j4 = l0 - j2;
