...
public class C5441g implements java.util.Collection, Serializable, Collection {
    private static final long serialVersionUID = 3053995032091335093L;
    public final java.util.Collection a;
    public final Object b;

    public C5441g(java.util.Collection collection) {
        this.a = (java.util.Collection) Objects.requireNonNull(collection);
        this.b = this;
    }

    public C5441g(java.util.Collection collection, Object obj) {
        this.a = (java.util.Collection) Objects.requireNonNull(collection);
    ...
    public final java.util.stream.Stream parallelStream() {
        return Stream.Wrapper.convert(j$.com.android.tools.r8.a.Z(this.a));
    }
    ...
    public final java.util.Spliterator spliterator() {
        return Spliterator.Wrapper.convert(j$.com.android.tools.r8.a.c0(this.a));
    }
    ...
    public final java.util.stream.Stream stream() {
        return Stream.Wrapper.convert(j$.com.android.tools.r8.a.d0(this.a));
    }
