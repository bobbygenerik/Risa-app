...
## 2026-05-18 - [Enum Serialization Optimization]
...
**Action:** Use the built-in `enum.name` property (available in Dart 2.15+) which is evaluated at compile time or highly optimized, eliminating runtime string manipulation overhead.
